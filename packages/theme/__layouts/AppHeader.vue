      ...
      <div class='w-auto flex flex-col'>
        <div class='flex justify-between'>
          <div class='flex flex-none'>
            <SearchBar
              :suggestionItems='searchSuggestion'
              :onSearchTyping='onSearchSuggestion'
            />
          </div>
...
import CustomerBar from '~/components/features/customer/CustomerBar';
import LoginModal from '~/components/features/customer/LoginModal';
import RegisterModal from '~/components/features/customer/RegisterModal';
